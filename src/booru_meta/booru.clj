...
(defn danbooru [postid-or-md5]
  (let [preprocess
    ...
    (cond
      (md5? postid-or-md5) (get-metadata (mk-opt (str "md5:" postid-or-md5)))
      (int-only? postid-or-md5) (get-metadata (mk-opt (str "id:" postid-or-md5)))
